										...
										<div class="modal-dialog">
											<div class="modal-content">
												...
												<div class="modal-body">
													...
													<div class="mb-3 row">
														<div class="col">
															<label for="log_threshold" class="form-label"><?= __("Optional: Error Logs"); ?><i id="logging_tooltip" data-bs-toggle="tooltip" data-bs-placement="top" class="fas fa-question-circle text-muted ms-2" data-bs-custom-class="custom-tooltip" data-bs-html="true" data-bs-title="<?= __("Optional: Enable Error Logging by setting the log threshold bigger then 0. Only enable this if you really need it."); ?>"></i></label>
