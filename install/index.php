								...
								<div class="tab-pane fade" id="configuration" role="tabpanel" aria-labelledby="configuration-tab">
									<div class="row">
										...
										<div class="col">
											...
											<div class="mb-3">
												<label for="global_call_lookup" class="form-label"><?= __("Optional: Global Callbook Lookup"); ?><i id="callbook_tooltip" data-bs-toggle="tooltip" data-bs-placement="top" class="fas fa-question-circle text-muted ms-2" data-bs-custom-class="custom-tooltip" data-bs-html="true" data-bs-title="<?= __("This configuration is optional. The callsign lookup will be available for all users of this installation. You can choose between QRZ.com, HamQTH, QRZCQ, QRZ.ru and QRZCALL.EU. While HamQTH also works without username and password, you will need credentials for the other providers. QRZ.com needs an XML subscription for the Call Locator; QRZCALL.EU needs a Data or Extra subscription on https://qrzcall.eu/. HamQTH does not always provide the locator information."); ?>"></i></label>
