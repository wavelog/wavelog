...
/*
        Tag Wavelog as Version 1.4
*/

class Migration_tag_1_4 extends CI_Migration {      
    ...
    public function up()
    {
        ...
        $this->db->update('options', array('option_value' => '1.4'));
    ...
    {
        $this->db->where('option_name', 'version');
        $this->db->update('options', array('option_value' => '1.3.1'));  
    }
}