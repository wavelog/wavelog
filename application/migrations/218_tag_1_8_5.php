...
/*
        Tag Wavelog as Version 1.8.5
*/

class Migration_tag_1_8_5 extends CI_Migration {
    ...
    public function up()
    {
        ...
        $this->db->update('options', array('option_value' => '1.8.5'));
    ...
    {
        $this->db->where('option_name', 'version');
        $this->db->update('options', array('option_value' => '1.8.4'));
    }
}
