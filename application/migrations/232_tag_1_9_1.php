...
/*
        Tag Wavelog as Version 1.9.1
*/

class Migration_tag_1_9_1 extends CI_Migration {
    ...
    public function up()
    {
        ...
        $this->db->update('options', array('option_value' => '1.9.1'));
    ...
    {
        $this->db->where('option_name', 'version');
        $this->db->update('options', array('option_value' => '1.9'));
    }
}
