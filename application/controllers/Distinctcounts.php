...
class Distinctcounts extends CI_Controller {
    ...
    public function index() {
        $data['page_title'] = __("Distinct Counts");
        ...
        $this->load->view('distinctcounts/index');
        $this->load->view('interface_assets/footer');
    }

    public function get_counts() {
        $this->load->model('distinctcounts_model');

        $data = $this->distinctcounts_model->get_counts($this->input->post());
    ...
    public function details() {
        ...
        $data['results'] = $this->distinctcounts_model->qso_details($type, $group, $band, $sat, $propagation, $mode, $orbit, $dateFrom, $dateTo);
        $data['adif_propmodes'] = $this->config->item('adif_propmodes');

        $data['page_title'] = "Log View - " . $group;
        $data['filter'] = __("QSOs with") . " " . $group;
