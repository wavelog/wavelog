...
/* 
	...
	Provides outputted cdf files for use with Google Map services 
	All maps are stored within /cdf in the root directory
...
class Kmlexport extends CI_Controller {
	...
	public function export() {
		...
		$qsos = $this->logbook_model->cdf_get_all_qsos($band, $mode, $dxcc, $cqz, $propagation, $fromdate, $todate);

		$output = "<?xml version=\"1.0\" encoding=\"utf-8\"?>";
		$output .= "<cdf xmlns=\"http://www.opengis.net/cdf/2.2\">";
		...
		header("Content-Disposition: attachment; filename=\"qsos.cdf\"");
		echo $output;
