...
class User_Model extends CI_Model {
	...
	function update_session($id, $u = null, $impersonate = false, $custom_data = null) {
		...
		$userdata = array(
            ...
            'user_dashboard_show_dxpeditions' => ((($this->session->userdata('user_dashboard_show_dxpeditions') ?? '1') == '1') ? $this->user_options_model->get_options('dashboard', array('option_name' => 'show_dxpeditions', 'option_key' => 'boolean'))->row()->option_value ?? '1' : $this->session->userdata('user_dashboard_show_dxpeditions')),
            'user_dashboard_show_contests' => ((($this->session->userdata('user_dashboard_show_contests') ?? '1') == '1') ? $this->user_options_model->get_options('dashboard', array('option_name' => 'show_contests', 'option_key' => 'boolean'))->row()->option_value ?? '1' : $this->session->userdata('user_dashboard_show_contests')),
