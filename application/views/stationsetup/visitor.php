					...
					<p><?php echo __("Setting a public slug allows you to share your logbook with anyone via a custom website address, this slug can contain letters & numbers only."); ?></p>
					<p><?php echo __("Later it looks like this:")?><br>
					<?php echo site_url('visitor'); ?>/<?php echo __("[your slug]"); ?></p>
					...
					<div class="mb-3">
						...
						<label for="publicSlugInput"><?php echo __("Type in Public Slug choice"); ?></label>
					...
					<div id="slugLink" class="alert alert-info" role="alert" style="margin-top: 20px;">
						<p><?php echo __("Visit Public Page") . " "; ?></p>
