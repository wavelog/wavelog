<div class="container">
    <br>
    <h2><?= sprintf(__("Club Permissions for %s"), '<span class="callsign">' . htmlspecialchars($club->user_callsign) . '</span>'); ?></h2>
                    ...
                    <div class="modal-content">
                        ...
                        <form action="<?= site_url('club/alter_member'); ?>" method="post">
                            <div class="modal-body">
                                ...
                                <p>
                                    <?= sprintf(__("You can only add users to the %s Clubstation if they already exist on this Wavelog Server."), '<span class="callsign">' . htmlspecialchars($club->user_callsign) . '</span>'); ?>
                        ...
                        <tbody>
                            <?php foreach ($club_members as $member) { ?>
                                <tr>
                                    ...
                                    <td class="callsign" style="text-align: center; vertical-align: middle;"><?php echo $member->user_callsign; ?></td>
                                                                    ...
                                                                    <tbody>
                                                                        <tr>
                                                                            <td class="text-center pt-3">
                                                                                <p><b><span class="callsign"><?php echo $member->user_callsign; ?></span> - <?php echo $member->user_firstname . ' ' . $member->user_lastname; ?></b></p>
                                                                            </td>
                                                                            <td>
                                                                                <select class="form-select" id="permission" name="permission" required>
                                                ...
                                                <div class="modal-content">
                                                    ...
                                                    <form action="<?= site_url('club/delete_member'); ?>" method="post">
                                                        <div class="modal-body" style="text-align: center !important;">
                                                            ...
                                                            <div class="mb-3">
                                                                <p>
                                                                    <?= sprintf(__("Callsign: %s"), '<span class="callsign">' . htmlspecialchars($member->user_callsign) . '</span>'); ?><br>
