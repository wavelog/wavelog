            ...
            <div class="col">
                ...
                <form name="qsos" id="qsoform">
					...
					<li class="nav-item">
                                ...
                                <div class="actions">
                                    <a class="btn btn-danger" href="javascript:qso_delete(<?php echo (int) $qso->COL_PRIMARY_KEY; ?>, '<?php echo html_escape($qso->COL_CALL); ?>')"><i class="fas fa-trash-alt"></i> <?= __("Delete QSO"); ?></a>
