...
<div class="container px-3 px-lg-4 mt-3 mb-3">
    <h3><?= __("QSL Postcard Designer (4x6 Landscape)"); ?></h3>
    ...
    <div class="row">
        <div class="col-md-3">
            ...
            <div class="card p-2 mt-3">
                <h5 class="mb-2"><?= __("Selected Element"); ?></h5>
            ...
            <div class="card p-2">
                ...
                <div class="mb-2"><strong><?= __("Address"); ?></strong></div>
                ...
                <div class="mb-2"><strong><?= __("QSO"); ?></strong></div>
