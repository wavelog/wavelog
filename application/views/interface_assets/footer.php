...
<?php if ($this->uri->segment(1) == "logbook" || $this->uri->segment(1) == "logbookadvanced" || $this->uri->segment(1) == "eqsl" || $this->uri->segment(1) == "generic_qsl" || $this->uri->segment(1) == "activators" || $this->uri->segment(1) == "distancerecords" || $this->uri->segment(1) == "timeline" || $this->uri->segment(1) == "callstats" || $this->uri->segment(1) == "statistics" || $this->uri->segment(1) == "countqsoby" || $this->uri->segment(1) == "awards") { ?>
    <script type="text/javascript" src="<?php echo $this->paths->cache_buster('/assets/js/leaflet/L.Maidenhead.js'); ?>"></script>
    <script id="leafembed" type="text/javascript" src="<?php echo $this->paths->cache_buster('/assets/js/leaflet/leafembed.js'); ?>" tileUrl="<?php echo $this->optionslib->get_option('option_map_tile_server');?>"></script>
<?php } ?>
