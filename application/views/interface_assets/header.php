...
<body>
	...
	<nav class="navbar navbar-expand-lg navbar-light bg-light main-nav">
		<div class="container">
			<a class="navbar-brand" href="<?php echo site_url(); ?>"><img src="<?php echo base_url(); ?>assets/logo/<?php echo $this->optionslib->get_theme(); ?>/wavelog_icon_only.png" alt="Logo" style="width:50px; height:50px;" /></a> <?php if (ENVIRONMENT == "development") { ?><span class="badge text-bg-danger"><?php echo lang('menu_badge_developer_mode'); ?></span><?php } ?>
