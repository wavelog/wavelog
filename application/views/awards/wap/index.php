...
<div class="container px-3 px-lg-4 mt-3 mb-3">
	...
	<div id="awardInfoButton">
		...
		var lang_award_info_ln5 = "<?= __("Fields taken for this Award: DXCC (Must be Netherlands) and STATE (Must contain a valid state abbreviation!)"); ?>";
		</script>
	...
	<div class="card">
		<div class="card-header">
			<ul class="nav nav-tabs card-header-tabs" id="myTab" role="tablist">
				...
				<li class="nav-item">
					<a class="nav-link" id="map-tab" onclick="load_wap_map();" data-bs-toggle="tab" href="#wapmaptab" role="tab" aria-controls="home" aria-selected="false"><i class="fas fa-map"></i> <?= __("Map"); ?></a>
				</li>
			</ul>
		</div>
		<div class="card-body">
