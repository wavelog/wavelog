...
<div class="container">
        ...
        <fieldset>
            ...
            <div class="mb-3 row">
                ...
                <div class="col-md-10">
					...
					<?php if ($rac_array) {
                        ?><button type="button" onclick="load_rac_map();" class="btn btn-info btn-sm"><i class="fas fa-globe-americas"></i> Show RAC Map</button>
                    <?php }?>
                </div>
            </div>
	...
	<ul class="nav nav-tabs" id="myTab" role="tablist">
        ...
        <li class="nav-item">
            <a class="nav-link" id="map-tab" onclick="load_rac_map();" data-bs-toggle="tab" href="#racmaptab" role="tab" aria-controls="home" aria-selected="false">Map</a>
        </li>
    </ul>
    <br />
