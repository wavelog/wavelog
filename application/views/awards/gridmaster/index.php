<div class="container gridsquare_map_form">
        ...
        <div id="awardInfoButton">
            ...
            <?php if (strtoupper($dxcc) == "US") { ?>
				...
				var lang_award_info_ln5 = "<?= __("Fields taken for this Award: DXCC (Must be USA), Gridsquare (Must contain a grid from one of the 488 mainland gridsquares!), Propagation-Mode and SAT-Name"); ?>";
            <?php } else { ?>
