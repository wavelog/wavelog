...
<div class="container timeplotter px-3 px-lg-4 mt-3 mb-3">
    <h2><?= __("Timeplotter"); ?></h2>

	<div class="card">
		<div class="card-header">
			<?= __("View a heatmap or a chart of QSOs"); ?>
		</div>
		<div class="card-body">
			<div class="card shadow-sm mb-4">
				<div class="card-body">
					<form id="timeplotter-filters" class="row gy-3 gx-3 align-items-end" novalidate>
						...
						<div class="col-12 col-md-3">
							<button id="button1id" type="button" name="button1id" class="btn btn-sm btn-primary w-100 ld-ext-right" onclick="timeplot(this.form);"><?= __("Show"); ?><div class="ld ld-ring ld-spin"></div></button>
						</div>
					</form>
				</div>
			</div>
			...
			<div class="row g-3 mb-3" id="timeplotter-summary" style="display:none;">
				<div class="col-6 col-md-3">
					<div class="card summary-card h-100">
						<div class="card-header">
							<h6 class="mb-0"><?= __("Best Time Window"); ?></h6>
						</div>
						<div class="card-body">
				...
				<div class="col-6 col-md-3">
					<div class="card summary-card h-100">
						<div class="card-header">
							<h6 class="mb-0"><?= __("Total QSOs Plotted"); ?></h6>
						</div>
						<div class="card-body">
