    ...
    <div class="my-2 rounded-0 shadow-sm card mb-2 shadow-sm">
        <div class="card-body">
            <div class="text-center">
                        <h3 class="text-center"><?php echo __("Forgot Password?"); ?> <i class="fa fa-lock"></i></h3>
                    ...
                    <form id="register-form" role="form" autocomplete="off" class="form" method="post" action="<?php echo site_url('user/forgot_password'); ?>">
                        <div class="mb-3">
                            <div class="input-group">
                                ...
                                <input id="email" name="email" placeholder="<?php echo __("Email Address"); ?>" class="form-control" type="email" autofocus>
                            </div>
                        </div>
                        <div class="mb-3">
                            <input name="recover-submit" class="w-100 btn btn-primary btn-block" value="<?php echo __("Reset Password"); ?>" type="submit">
                        </div>
