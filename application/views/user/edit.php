							...
							<div class="card">
								...
								<div class="card-body">
									<div class="mb-3">
										...
										<input class="form-control" type="text" name="user_name" value="<?php if(isset($user_name)) { echo $user_name; } ?>" <?php if(isset($user_name) == 'demo' && file_exists('.demo') && $this->session->userdata('user_type') !== '99') { echo 'disabled'; } ?> />
