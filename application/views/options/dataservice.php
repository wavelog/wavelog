                ...
                <div class="card-body">
                    ...
                    <div class="mb-3">
                        ...
                        <p>
                            ...
                            <?= __("Rest assured, we do not store any personal data. The only information collected, alongside a timestamp, is the Wavelog ID (an anonymous, non-traceable random md5 hash), the 4-character Maidenhead grid (e.g., HA44), and the Wavelog version. We do not collect IP addresses or any other data that could identify users."); ?>
                            <?= __("If you prefer not to participate, you can either self-host the Dataservice or disable it entirely. However, please note that disabling the Dataservice will impact some features, such as displaying the local time information of the QSO partner's location in the currently logged QSO, but it does not affect any features essential for the operation of Wavelog."); ?>
                        </p>
                        <div class="mb-2">
