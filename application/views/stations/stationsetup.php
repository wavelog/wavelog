        ...
        <div>
            ...
            <div class="card">
				...
				<?php echo lang('station_logbooks')?>
					...
					<a class="btn btn-primary float-right mb-2" href="<?php echo site_url('logbooks/create'); ?>"><i class="fas fa-plus"></i> <?php echo lang('station_logbooks_create')?></a>
            ...
            <div class="card">
                ...
                <div class="card-body">
                    ...
                    <p><a href="<?php echo site_url('station/create'); ?>" class="btn btn-primary"><i
