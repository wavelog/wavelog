...
$lang['options_wavelog_options'] = 'Wavelog-alternativ';
$lang['options_message1'] = 'Wavelog-alternativ är globala inställningar som används för alla användare av installationen, som åsidosätts om det finns en inställning på användarnivå.';
