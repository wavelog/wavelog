...
$lang['station_logbooks_edit_name_hint'] = "Короткое название для журнала станции, например: Home Log (HM54ip)";
...
$lang['station_location_callsign_hint'] = 'Позывной станции, например: 4W7EST/P';
...
$lang['station_location_gridsquare_hint_ln1'] = "Квадрат станции, к примеру: HM54ip. Если вы не знаете свой квадрат, то <a href='https://zone-check.eu/?m=loc' target='_blank'>кликните сюда</a>!";
