...
class QSO
{
	...
	public function toArray(): array
	{
		return [
			...
			'region' => $this->region,
			'antennaelevation' => $this->antennaelevation == null ? null : round((float)$this->antennaelevation, 1).'°',
			'antennaazimuth' => $this->antennaazimuth == null ? null : round((float)$this->antennaazimuth, 1).'°',
			'county' => $this->county,
			'qth' => $this->qth,
